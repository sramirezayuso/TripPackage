...
public class TiketConnectorConfigDefinitionParser
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(TiketConnectorConnectionManager.class.getName());
        builder.setScope(BeanDefinition.SCOPE_SINGLETON);
        setInitMethodIfNeeded(builder, TiketConnectorConnectionManager.class);
        setDestroyMethodIfNeeded(builder, TiketConnectorConnectionManager.class);
