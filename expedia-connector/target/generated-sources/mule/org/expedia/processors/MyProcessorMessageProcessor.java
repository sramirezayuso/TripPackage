...
/**
 * MyProcessorMessageProcessor invokes the {@link org.expedia.ExpediaConnectorConnector#myProcessor(java.lang.String)} method in {@link ExpediaConnectorConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((ExpediaConnectorConnector) object).myProcessor(_transformedContent);
                }
