...
public class ExpediaConnectorConnectorConfigDefinitionParser
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ExpediaConnectorConnectorConnectionManager.class.getName());
        builder.setScope(BeanDefinition.SCOPE_SINGLETON);
        setInitMethodIfNeeded(builder, ExpediaConnectorConnectorConnectionManager.class);
        setDestroyMethodIfNeeded(builder, ExpediaConnectorConnectorConnectionManager.class);
